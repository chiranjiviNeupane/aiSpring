...
You can configure existing advisors using the [ChatClient API](api/chatclient.adoc#_advisor_configuration_in_chatclient) as shown in the following example:
...
* [Learn about Question Answer Advisor](ROOT:api/retrieval-augmented-generation.adoc#_questionansweradvisor)
* [Learn about Chat Memory Advisor](ROOT:api/chat-memory.adoc#_memory_in_chat_client)
...
![Advisors API Classes](advisors-api-classes.jpg)
...
![Advisors API Flow](advisors-flow.jpg)
...
The "[Re-Reading Improves Reasoning in Large Language Models](https://arxiv.org/pdf/2309.06275)" article introduces a technique called Re-Reading (Re2) that improves the reasoning capabilities of Large Language Models.
...
* `ToolCallingAdvisor`
  ...
  For full documentation, see [Recursive Advisors - ToolCallingAdvisor](api/advisors-recursive.adoc#_toolcallingadvisor) and [ChatClient - Tool Calling](api/chatclient.adoc#_tool_calling).
...
![Advisors Streaming vs Non-Streaming Flow](advisors-non-stream-vs-stream.jpg)
